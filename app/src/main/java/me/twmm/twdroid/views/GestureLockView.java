...
public class GestureLockView extends View {
    ...
    private static float RATE = 1/5.0f;
    private static int SPACE_BETWEEN_ARROW_AND_OUTER_CIRCLE=5;
    /**
     ...
     */
    private float mArrowRate = RATE;
    private int mArrowDegree = -1;
    private Path mArrowPath;
    /**
     * 内圆的半径 = mInnerCircleRadiusRate * mRadius
     */
    private float mInnerCircleRadiusRate = RATE;
    /**
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mArrowPath.moveTo(mWidth / 2, mStrokeWidth + SPACE_BETWEEN_ARROW_AND_OUTER_CIRCLE);
        mArrowPath.lineTo(mWidth / 2 - mArrowLength, mStrokeWidth + SPACE_BETWEEN_ARROW_AND_OUTER_CIRCLE
                + mArrowLength);
        mArrowPath.lineTo(mWidth / 2 + mArrowLength, mStrokeWidth + SPACE_BETWEEN_ARROW_AND_OUTER_CIRCLE
                + mArrowLength);
        mArrowPath.close();
